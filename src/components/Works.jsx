    ...
    <motion.div variants={fadeIn("up","spring",index*0.5,0.75)}>
      <Tilt
        options={{
          ...
          scale: 1,
          speed: 450
        }}  className="bg-tertiary p-5 rounded-2xl sm:w-[360px] w-full min-h-max ">
            <div className="relative w-full">
              <img src={image} alt={name} className="w-full h-[200px] object-fill rounded-2xl" />

              <div className="absolute inset-0 flex justify-end m-3 card-img_hove r">
